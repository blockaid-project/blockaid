...
import fatjdbc.utility.PrepareStatementTest;
 ...
 */
public class DbPrepareStatementTest extends PrepareStatementTest {
    ...
    public static void setUpDb() throws Exception {
        ...
        PrepareStatementTest.setUpClass(dbUrl);
        ...
        connInfo.setProperty("userRole", "controller");
