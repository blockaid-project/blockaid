...
import catalog.db.dao.DSSetDAO;
import catalog.db.encryption.AESEncrypt;
import catalog.db.encryption.NoopEncrypt;
...
public class Connection {
  ...
  public DBI getDbi() throws PrivacyException {
    if (dsSet == null) {
      throw new PrivacyException("DB Catalog not initialized correctly. DSSet is not found");
    }
    return this.dbi;
  }
}
