...
class MyUnsatCoreDeterminacyFormula extends BoundedDeterminacyFormula {
    ...
    public static MyUnsatCoreDeterminacyFormula create(Schema schema, Collection<Policy> policies,
        ...
        ListMultimap<String, Map<String, Object>> knownRows = computeKnownRows(schema, trace);
        System.out.println("\t\t| Known rows:\t" + knownRows);
        MyUnsatCoreDeterminacyFormula f =
                new MyUnsatCoreDeterminacyFormula(schema, policies, views, trace, slackBounds, knownRows);
    ...
    private static ListMultimap<String, Map<String, Object>> computeKnownRows(Schema schema, QueryTrace trace) {
